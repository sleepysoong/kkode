...
func TestSyncRunPreviewerShowsEffectiveAssembly(t *testing.T) {
	...
	if len(preview.LocalTools) != 2 || preview.LocalTools[0] != "file_read" || preview.LocalTools[1] != "lsp_symbols" {
