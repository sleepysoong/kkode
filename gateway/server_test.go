...
func TestGatewayStatsEndpoint(t *testing.T) {
	...
	if stats.Sessions != 1 || stats.Turns != 1 || stats.Events != 1 || stats.EventsByType["turn.completed"] != 1 || stats.RunEvents != 1 || stats.RunEventsByType["run.running"] != 1 || stats.Todos != 1 || stats.TodosByStatus[string(session.TodoPending)] != 1 || stats.Checkpoints != 1 || stats.TotalRuns != 1 || stats.Runs["running"] != 1 || stats.RunDuration.Count != 1 || stats.RunDuration.SumMS != 1200 || stats.RunDuration.AvgMS != 1200 || stats.RunDuration.MaxMS != 1200 || stats.RunDuration.P95MS != 1200 || stats.RunDurationByProvider["copilot"].P95MS != 1200 || stats.RunDurationByModel["gpt-5-mini"].P95MS != 1200 || stats.RunUsage.TotalTokens != 9 || stats.RunUsage.ReasoningTokens != 2 || stats.RunUsageByProvider["copilot"].TotalTokens != 9 || stats.RunUsageByModel["gpt-5-mini"].TotalTokens != 9 || stats.TotalResources != 1 || stats.Resources[string(session.ResourceMCPServer)] != 1 {
