...
func DefaultFeatureCatalog() []FeatureDTO {
	return []FeatureDTO{
		...
		{Name: "files", Status: "implemented", Description: "웹 패널용 파일 목록, 읽기, 쓰기, delete, move, patch, restore, glob, grep API를 제공해요. 쓰기 계열은 권한 프롬프트 없이 실행 전 checkpoint_id를 남겨요.", Endpoints: []string{"GET /api/v1/files", "GET /api/v1/files/content", "PUT /api/v1/files/content", "POST /api/v1/files/delete", "POST /api/v1/files/move", "POST /api/v1/files/patch", "POST /api/v1/files/restore", "GET /api/v1/files/glob", "GET /api/v1/files/grep"}},
