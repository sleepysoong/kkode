...
func DefaultFeatureCatalog() []FeatureDTO {
	return []FeatureDTO{
		...
		{Name: "todos", Status: "implemented", Description: "agent todo 상태를 외부 status UI에서 읽을 수 있어요.", Endpoints: []string{"GET /api/v1/sessions/{session_id}/todos", "PUT /api/v1/sessions/{session_id}/todos", "POST /api/v1/sessions/{session_id}/todos", "DELETE /api/v1/sessions/{session_id}/todos/{todo_id}"}},
