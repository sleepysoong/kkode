...
func DefaultFeatureCatalog() []FeatureDTO {
	return []FeatureDTO{
		...
		{Name: "sessions", Status: "implemented", Description: "session 생성, 목록, 상세, export, turn/transcript 조회, compact, fork를 제공해요.", Endpoints: []string{"GET /api/v1/sessions", "POST /api/v1/sessions", "GET /api/v1/sessions/{session_id}", "GET /api/v1/sessions/{session_id}/export", "GET /api/v1/sessions/{session_id}/turns", "GET /api/v1/sessions/{session_id}/turns/{turn_id}", "GET /api/v1/sessions/{session_id}/transcript", "POST /api/v1/sessions/{session_id}/compact", "POST /api/v1/sessions/{session_id}/fork"}},
		...
		{Name: "background_runs", Status: "implemented", Description: "run을 즉시 접수하고 background 상태 조회, 취소, live SSE event, 실행 전 preview를 제공해요.", Endpoints: []string{"GET /api/v1/runs", "POST /api/v1/runs", "POST /api/v1/runs/preview", "GET /api/v1/runs/{run_id}", "GET /api/v1/runs/{run_id}/events", "POST /api/v1/runs/{run_id}/cancel", "POST /api/v1/runs/{run_id}/retry", "GET /api/v1/requests/{request_id}/runs", "GET /api/v1/requests/{request_id}/events"}},
