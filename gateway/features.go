...
func DefaultFeatureCatalog() []FeatureDTO {
	return []FeatureDTO{
		...
		{Name: "artifacts", Status: "implemented", Description: "큰 tool output, diff, preview 같은 산출물을 session/run/turn별로 저장하고 조회/삭제/정리할 수 있어요.", Endpoints: []string{"GET /api/v1/sessions/{session_id}/artifacts", "POST /api/v1/sessions/{session_id}/artifacts", "POST /api/v1/sessions/{session_id}/artifacts/prune", "GET /api/v1/artifacts/{artifact_id}", "DELETE /api/v1/artifacts/{artifact_id}"}},
		...
		{Name: "files", Status: "implemented", Description: "웹 패널용 파일 목록, 읽기, 쓰기, delete, move, patch, restore, checkpoint list/delete/prune, glob, grep API를 제공해요. 쓰기 계열은 권한 프롬프트 없이 실행 전 checkpoint_id를 남겨요.", Endpoints: []string{"GET /api/v1/files", "GET /api/v1/files/content", "PUT /api/v1/files/content", "POST /api/v1/files/delete", "POST /api/v1/files/move", "POST /api/v1/files/patch", "POST /api/v1/files/restore", "GET /api/v1/files/checkpoints", "POST /api/v1/files/checkpoints/prune", "GET /api/v1/files/checkpoints/{checkpoint_id}", "DELETE /api/v1/files/checkpoints/{checkpoint_id}", "GET /api/v1/files/glob", "GET /api/v1/files/grep"}},
...
func APIIndexLinks() map[string]string {
	return map[string]string{
		...
		"session_artifacts":         "/api/v1/sessions/{session_id}/artifacts",
		"session_artifact_create":   "/api/v1/sessions/{session_id}/artifacts",
		"session_artifacts_prune":   "/api/v1/sessions/{session_id}/artifacts/prune",
		"artifact_detail":           "/api/v1/artifacts/{artifact_id}",
		"artifact_delete":           "/api/v1/artifacts/{artifact_id}",
		"runs":                      "/api/v1/runs",
		...
		"file_delete":               "/api/v1/files/delete",
		"file_move":                 "/api/v1/files/move",
		"file_patch":                "/api/v1/files/patch",
		"file_restore":              "/api/v1/files/restore",
		"file_checkpoints":          "/api/v1/files/checkpoints",
		"file_checkpoints_prune":    "/api/v1/files/checkpoints/prune",
		"file_checkpoint_detail":    "/api/v1/files/checkpoints/{checkpoint_id}",
		"file_checkpoint_delete":    "/api/v1/files/checkpoints/{checkpoint_id}",
...
func apiIndexLinkMethods() map[string]string {
	return map[string]string{
		...
		"session_artifact_create":   "POST",
		"session_artifacts_prune":   "POST",
		...
		"file_patch":                "POST",
		"file_restore":              "POST",
		"file_checkpoints_prune":    "POST",
		"file_checkpoint_delete":    "DELETE",
