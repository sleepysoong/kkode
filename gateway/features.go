...
func DefaultFeatureCatalog() []FeatureDTO {
	return []FeatureDTO{
		...
		{Name: "lsp", Status: "implemented", Description: "Go source symbol index와 definition/reference를 LSP-style API로 조회할 수 있어요.", Endpoints: []string{"GET /api/v1/lsp/symbols", "GET /api/v1/lsp/document-symbols", "GET /api/v1/lsp/definitions", "GET /api/v1/lsp/references"}},
