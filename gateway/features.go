...
func DefaultFeatureCatalog() []FeatureDTO {
	return []FeatureDTO{
		...
		{Name: "artifacts", Status: "implemented", Description: "큰 tool output, diff, preview 같은 산출물을 session/run/turn별로 저장하고 조회/삭제할 수 있어요.", Endpoints: []string{"GET /api/v1/sessions/{session_id}/artifacts", "POST /api/v1/sessions/{session_id}/artifacts", "GET /api/v1/artifacts/{artifact_id}", "DELETE /api/v1/artifacts/{artifact_id}"}},
