...
func TestSQLiteStoreLoadsDashboardStats(t *testing.T) {
	...
	if stats.Sessions != 1 || stats.Turns != 1 || stats.Events != 1 || stats.RunEvents != 1 || stats.RunEventsByType["run.completed"] != 1 || stats.Todos != 1 || stats.Checkpoints != 1 || stats.Artifacts != 1 {
